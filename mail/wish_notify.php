...
<b><?php echo date("Y-m-d"); ?></b> 依据约定已转账<span style="color:red;font-weight:700">￥<?php echo $money; ?></span>至您的平台钱包！如需体现，请登录后发起申请！ </p>

<?php elseif ($role == 'sponsor'): ?>

<p>您在人恋人平台资助的心愿 <span style="color:red;font-weight:700"> <?php echo $wish_id; ?> </span> 于
<b><?php echo date("Y-m-d"); ?></b> 依据约定从你的平台钱包转出<span style="color:red;font-weight:700">￥<?php echo $money; ?></span></p>
...
<b><?php echo date("Y-m-d"); ?></b> 依据约定本应转账的事件因资助者余额不足而中断，请积极与双方联系交涉，推动心愿的正常进行！</p>
