...
<div class="col-lg-12">
	<ul class="nav nav-tabs" id="menu">
		...
		<li><a href=<?=Url::to(['team/vote','team_id'=>Yii::$app->request->get('team_id')])?>>团体投票活动</a></li>
		<?php if(Yii::$app->session->get('team')->isCreator()): ?>
		<li><a href=<?=Url::to(['team/newvote','team_id'=>Yii::$app->request->get('team_id')])?>>发起资助投票</a></li>			
		<?php endif; ?>
	</ul>
	<ul id="nav_option"></ul>
</div>
